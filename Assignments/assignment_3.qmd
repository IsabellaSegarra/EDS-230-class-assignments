...
![conceptual model](images/crop_yield_conceptual_model.png)
...
crop_yield <- function(crop, temp_var, precip_var, temp_var2 = 0, precip_var2 = 0) {
 ...
 if(crop == "Almonds") {
   ...
   y <- (2.65 *temp_var) - (0.17 * temp_var ^2) + (4.78 * precip_var) - (4.93 * precip_var ^2) - (2.24 * precip_var2) + (1.54*precip_2^2) - 10.50
