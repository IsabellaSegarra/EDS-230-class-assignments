...
```{r}
# Inputs in function: A, r, H, PR

# The following function will produce an estimate of energy produced from a photovoltaic system with inputs of solar panel area and annual average solar radition. 

# Name function 
photovoltaic_energy <- 
  # Define the function arguments to represent the defined equation above 
  function(A, H){ 
