...
*eff* – 0.6 instead of default 0.8
...
What happens when we vary parameters? \* Not always obvious when transfer function is non-linear or multi-part
...
eff <- rnorm(mean = 0.6, sd = 0.1, n = 20) # 20 samples 
