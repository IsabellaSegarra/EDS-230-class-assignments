...
filled.contour(t(result$conc), xlab = "Time", ylab = "Distance")
...
```{r}
# informal sensitivity analysis (more boxes, initial C changes)

# Change initial concentration
result2 = diff1(initialC = 100, nx = 15, dx = 0.5, nt = 8, dt = 1, D = 0.8, area = 10)

filled.contour(result2$conc, xlab = "Time", ylab = "Distance")
