...
res <- pmap_dbl(parms, compute_almond_yield2, clim=clim) # almond_yield 2 gives back 1 mean 

#

sens_Catm_Sobol <- sensitivity::tell(sens_Catm_Sobol, res, res.names = "yield")
...
both <- cbind.data.frame(parms, mean_annual_yields = sens_Catm_Sobol$y)
...
sens_Catm_Sobol2 <- sensitivity::tell(sens_Catm_Sobol2, res, res.names = "yield")
